...
import time
import datetime
from get_threat_actor import*
from get_threat_actor_details import*
from get_industry_choice import*
...
#industry_list = ['Aviation', 'Aerospace', 'Transportation', 'Government']
#industry_list = ['Aviation']
...
country_list, motivation_list, first_seen_list, sponsor_list, description_list, observed_countries_list, tools_list, information_list, mitre_attack_list, playbook_list = get_threat_actor_details(url_list)
...
df.to_excel(filepath + str(dt_string) + "_" + str(industry) + "_" +"threat_actor.xlsx")
