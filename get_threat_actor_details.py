...
def get_threat_actor_details(url_list):
    ...
    return country_list, motivation_list, first_seen_list, sponsor_list, description_list, observed_countries_list, tools_list, information_list, mitre_attack_list, playbook_list